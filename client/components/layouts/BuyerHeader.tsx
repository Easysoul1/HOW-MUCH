  ...
  return (
    <header className="h-16 border-b border-gray-100 bg-white sticky top-0 z-50 flex items-center justify-between px-6 lg:px-10">
      <div className="flex items-center gap-4 flex-1">
         ...
         <h1 className="font-milano font-medium text-lg hidden sm:block">My Dashboard</h1>
      </div>
      ...
      <div className="flex items-center gap-4 md:gap-6">
        <div className="relative hidden md:block">
            ...
            <input 
                ...
                className="pl-9 pr-4 py-2 bg-gray-50 rounded-full text-sm focus:outline-none focus:ring-1 focus:ring-black w-48 lg:w-64"
            />
        </div>
