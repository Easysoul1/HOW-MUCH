                          ...
                          <tr key={vendor.id} className="hover:bg-gray-50 transition-colors">
                              <td className="px-6 py-4">
                                  <div className="flex items-center gap-3">
                                      <div 
                                        className="w-10 h-10 rounded-full bg-cover bg-center border border-light-border"
                                        style={{ backgroundImage: `url(${vendor.image_url || 'https://via.placeholder.com/150'})` }}
                                      />
                                      <div>
                                          <div className="font-medium text-gray-900">{vendor.business_name || vendor.username || 'Unnamed Vendor'}</div>
